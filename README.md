...
| v0.4 | zk Privacy Layer | **In progress** — a real proof verifies on chain; the nullifier gate is next |
...
Current: **290 contract tests**, **19 circuit tests**, 12 backend packages, **30 end-to-end tests**, Slither clean.
