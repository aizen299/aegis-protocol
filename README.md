...
Current: **353 contract tests**, **21 circuit tests**, **26 zk service tests**, **62 Solana tests**, **112 frontend tests**, 16 backend packages, **43 end-to-end tests**, Slither clean.
