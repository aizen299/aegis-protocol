...
Current: **353 contract tests**, **21 circuit tests**, **26 zk service tests**, **61 Solana tests**, **112 frontend tests**, 16 backend packages, **42 end-to-end tests**, Slither clean.
