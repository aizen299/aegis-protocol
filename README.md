...
Current: **367 contract tests**, **21 circuit tests**, **26 zk service tests**, **93 Solana tests**, **112 frontend tests**, 16 backend packages, **45 end-to-end tests**, Slither clean.
