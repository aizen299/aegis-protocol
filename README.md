...
| v0.4 | zk Privacy Layer | **In progress** — contracts and proof service done; indexing next |
...
contains the secret. The depth constant
...
Current: **334 contract tests**, **19 circuit tests**, **25 zk service tests**, 12 backend packages, **32 end-to-end tests**, Slither clean.
